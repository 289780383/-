...
$(function () {
    ...
    /**点击选择单程或者往返*/
    $(".dan_or li").on("click", dan_or);
    $(".dan_or").each(function () {
         $(this).find("li").eq(0).addClass("sel_dan");
    })
    /**初始化价格*/
    computer_($(".dan_or").each(function () {
            return $(this).find("li").eq(0)
        })
    )
...
/**点击选择单程或者往返*/
function dan_or() {
    $(this).parent().find("li").removeClass("sel_dan");
    $(this).parent().find(".dan_r span").removeClass("sel_dan2");
    $(this).addClass("sel_dan");
    $(this).find(".dan_r span").addClass("sel_dan2");
    /**点击计算价格*/
    computer_(this);
}
/**点击计算价格*/
function computer_(obj) {
    $(obj).parents(".bc_right").find(".bc_money1 i").text(parseInt($(obj).parents(".bc_right").find(".sel_dan2").text()).toFixed(1));
    var all = parseInt($(obj).parents(".bc_right").find(".sel_dan2").text()) + parseInt($(obj).parents(".bc_right").find(".bc_money i").text())
    $(obj).parents(".bc_right").find(".bc_money2 i").text(all.toFixed(1));
}
