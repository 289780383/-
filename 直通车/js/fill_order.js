    ...
    function write_name(e) {
        e.stopPropagation();
    }

    function input_val() {
            $(this).val($(this).val().NoSpace());
    }
    ...
    function talk_save() {
        if ($(".sel_contacts").length > 0) {
            ...
            $(".main_list .the_name input").val(name);
            $(".main_list .the_tel input").val(tel);
            $(".contacts_warp").hide();
        } else {
    ...
    $(function() {
        ...
        $(".the_name input").on("click", write_name);
        $(".the_name input").on("blur", input_val);
